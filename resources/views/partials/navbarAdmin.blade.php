...
<a href="{{ route('admin.mahasiswa.aktivasiAkun') }}"
   ...
   {{ request()->routeIs('admin.mahasiswa.aktivasiAkun')
    ...
    Aktivasi Akun
                ...
                <a href="{{ route('admin.akademik_staff.index') }}" class="block px-4 py-2.5 text-sm transition {{ request()->routeIs('admin.akademik_staff.index') ? 'bg-[#3da76e]/20 border-l-4 border-green-400 font-semibold text-white' : 'pl-5 font-medium text-green-100/70 hover:text-white' }}">Kelola Staf Akademik</a>
            </div>
        </div>
        ...
        <div class="mt-4 overflow-hidden rounded-lg bg-[#245d43]/50">
            ...
            <div data-accordion-content class="hidden">
                 <a href="{{ route('admin.profile') }}" class="block px-4 py-2.5 text-sm transition {{ request()->routeIs('admin.profile') ? 'bg-[#3da76e]/20 border-l-4 border-green-400 font-semibold text-white' : 'pl-5 font-medium text-green-100/70 hover:text-white' }}">Profil Saya</a>
            </div>
        </div>
</div>
